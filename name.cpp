...
void make_scene() {
    ...
    int i = 0;
    i = add_vertex(  0, 0.01, 0, coords, indexes, i);
    i = add_vertex(0.4, 1, 0, coords, indexes, i);
    i = add_vertex(0.6, 1, 0, coords, indexes, i);
    i = add_vertex(0.2, 0.01, 0, coords, indexes, i);
    letter_shapes.push_back(new Mesh(coords, 4, 4,
                                     ...
                                     "Left of A"));
    i = 0;
    i = add_vertex(1,0, 0.01, coords, indexes, i);
    i = add_vertex(0.6, 1, 0, coords, indexes, i);
    i = add_vertex(0.4, 1, 0, coords, indexes, i);
    i = add_vertex(0.8, 0.01, 0, coords, indexes, i);
    letter_shapes.push_back(new Mesh(coords, 4, 4,
                                     indexes, 4,
                                     4,
                                     GL_TRIANGLE_FAN, program_handle,
                                     "Right of A"));
    i = 0;
    i = add_vertex(0.4, 0.5, 0, coords, indexes, i);
    i = add_vertex(0.6, 0.5, 0, coords, indexes, i);
    i = add_vertex(0.6, 0.4, 0, coords, indexes, i);
    ...
    i = add_vertex(1.2, 1, 0, coords, indexes, i);
    ...
    i = add_vertex(2.8, 0.5, 0, coords, indexes, i);
    i = add_vertex(2.8, 0.01, 0, coords, indexes, i);
    i = add_vertex(2.8, 0.2, 0, coords, indexes, i);
    i = add_vertex(2.7, 0.01, 0, coords, indexes, i);
    ...
    i = add_vertex(3.2, 0.2, 0, coords, indexes, i);
    i = add_vertex(3.3, 0.01, 0, coords, indexes, i);
    i = add_vertex(3.7, 0.01, 0, coords, indexes, i);
    i = add_vertex(3.8, 0.2, 0, coords, indexes, i);
    i = add_vertex(3.8, 0.5, 0, coords, indexes, i);
    i = add_vertex(3.8, 0.01, 0, coords, indexes, i);
    letter_shapes.push_back(new Mesh(coords, 7, 4,
                                     indexes, 7,
                                     7,
                                     GL_LINE_STRIP, program_handle,
    ...
    i = add_vertex(4.8, 0.15, 0, coords, indexes, i);
    i = add_vertex(4.8, 0.2, 0, coords, indexes, i);
    i = add_vertex(4.7, 0.25, 0, coords, indexes, i);
    i = add_vertex(4.3, 0.25, 0, coords, indexes, i);
    i = add_vertex(4.2, 0.3, 0, coords, indexes, i);
    i = add_vertex(4.2, 0.35, 0, coords, indexes, i);
    ...
    i = add_vertex(6.3, 0.01, 0, coords, indexes, i);
    i = add_vertex(6.2, 0.2, 0, coords, indexes, i);
    ...
    i = add_vertex(6.8, 0.25, 0, coords, indexes, i);
    i = add_vertex(6.2, 0.25, 0, coords, indexes, i);
    ...
    // letter "r"
    i = 0;
    i = add_vertex(7.2, 0.01, 0, coords, indexes, i);
    i = add_vertex(7.2, 0.5, 0, coords, indexes, i);
